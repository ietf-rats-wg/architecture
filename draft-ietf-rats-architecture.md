...
provides trustworthy device identity, and performs a series of operations that allows other components to be trusted. 
...
Measurements can describe a variety of component attributes, such as hardware,
...
The bottom layer of an Attester has an Attesting Environment that is implicitly trusted, 
typically because it is designed to be immutable or difficult to modify by malicious code.
