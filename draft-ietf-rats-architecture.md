...
* Appraisal Policy for Attestation Result: A set of rules that direct how a Relying Party evaluates the Verifiers' evaluation results about an Attester. Compare /security policy/ in \[RFC4949\].
