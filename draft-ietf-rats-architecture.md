...
: A secure statement that an Endorser (typically a manufacturer) vouches for the integrity of an Attester. It may include implied Claims.
...
: A set of Claims about an Attester that is to be appraised by a Verifier.
