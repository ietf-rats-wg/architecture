...
create Evidence.
There is no limit to or requirement of places an Attesting Environment can exists, but they typically are in Trusted Execution Environments (TEE), embedded Secure Elements
