...
In the above use cases, the entity producing attestation is called the "Attester" and the entity considering the attestation is called the "Relying Party". A more formal terminology is provided in {{terminology}}.
